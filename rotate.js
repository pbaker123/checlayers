...
container.addEventListener("mousemove", function(event) {
  ...
  transform(midX, midY, distance, selectors);
  opacityAdjustment(opacity, selectors);
  
});

function transform(midX, midY, distance, selectors){
...
function opacityAdjustment(opacity, selectors) {
  if (opacity < .5) {
